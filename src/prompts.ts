...
export const createQuizGeneratingPrompt = (
  language: string
) => `You are a quiz generating AI. Create questions for the Horizontal Thinking quiz.
...
export const createQuizGameMasterTemplate = (
  quiz: Quiz
) => `You are the AI of the friendly game master who asks the human players lateral thinking quizzes.
